import {MapPin, Calendar, ArrowRight, UserRoundPlus, Settings2, X, Plus, User } from 'lucide-react'
import { FormEvent, useState } from 'react'
import { useNavigate } from 'react-router-dom'
import { InviteGuessModal } from './invite-guess-modal'
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 bg-zinc-900 space-y-5'>
            ...
            <form onSubmit={addEmail} className='space-y-3'>
              ...
              <button onClick={createTrip} type='submit' className='w-full justify-center bg-lime-300 text-lime-950 rounded-lg px-5 py-2 h-10 font-medium flex items-center gap-1 hover:bg-lime-400'>
